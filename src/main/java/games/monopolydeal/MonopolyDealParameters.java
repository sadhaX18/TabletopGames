...
public class MonopolyDealParameters extends TunableParameters {
    ...
    public MonopolyDealParameters() {
        ...
        addTunableParameter("focusType", CardType.class, possibleFocusActionCards);
                // GreenBlueRent + BrownLightBlueRent + PinkOrangeRent + RailRoadUtilityRent + RedYellowRent
                // split intensity between them
        _reset();
    }
